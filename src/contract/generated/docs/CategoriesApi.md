...
| [**apiV1CategoriesIdActivatePatch**](CategoriesApi.md#apiv1categoriesidactivatepatch) | **PATCH** /api/v1/categories/{id}/activate |  |
...
| [**apiV1CategoriesImageUploadSignaturePost**](CategoriesApi.md#apiv1categoriesimageuploadsignaturepost) | **POST** /api/v1/categories/image/upload-signature |  |
...
## apiV1CategoriesIdActivatePatch

> apiV1CategoriesIdActivatePatch(id)
...
import type { ApiV1CategoriesIdActivatePatchRequest } from '';
...
async function example() {
  ...
  } satisfies ApiV1CategoriesIdActivatePatchRequest;

  try {
    const data = await api.apiV1CategoriesIdActivatePatch(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
## apiV1CategoriesImageUploadSignaturePost
...
import type { ApiV1CategoriesImageUploadSignaturePostRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.apiV1CategoriesImageUploadSignaturePost();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
