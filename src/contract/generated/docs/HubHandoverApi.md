...
|------------- | ------------- | -------------|
| [**apiV1HubsHubIdDriversEligibleGet**](HubHandoverApi.md#apiv1hubshubiddriverseligibleget) | **GET** /api/v1/hubs/{hubId}/drivers/eligible |  |
...
## apiV1HubsHubIdDriversEligibleGet

> apiV1HubsHubIdDriversEligibleGet(hubId)
...
import type { ApiV1HubsHubIdDriversEligibleGetRequest } from '';
...
async function example() {
  ...
  } satisfies ApiV1HubsHubIdDriversEligibleGetRequest;

  try {
    const data = await api.apiV1HubsHubIdDriversEligibleGet(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
