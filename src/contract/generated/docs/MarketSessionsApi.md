...
|------------- | ------------- | -------------|
| [**apiV1MarketSessionsAvailabilityGet**](MarketSessionsApi.md#apiv1marketsessionsavailabilityget) | **GET** /api/v1/market-sessions/availability |  |
| [**apiV1MarketSessionsGet**](MarketSessionsApi.md#apiv1marketsessionsget) | **GET** /api/v1/market-sessions |  |



## apiV1MarketSessionsAvailabilityGet

> apiV1MarketSessionsAvailabilityGet(marketId, serviceDate)
...
import type { ApiV1MarketSessionsAvailabilityGetRequest } from '';
...
async function example() {
  ...
  } satisfies ApiV1MarketSessionsAvailabilityGetRequest;

  try {
    const data = await api.apiV1MarketSessionsAvailabilityGet(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
