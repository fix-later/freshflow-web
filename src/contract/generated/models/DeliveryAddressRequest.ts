...
export function DeliveryAddressRequestFromJSON(
    json: any
): DeliveryAddressRequest {
    return DeliveryAddressRequestFromJSONTyped(json, false);
}

export function DeliveryAddressRequestFromJSONTyped(
    json: any,
...
export function DeliveryAddressRequestToJSON(
    json: any
): DeliveryAddressRequest {
    return DeliveryAddressRequestToJSONTyped(json, false);
}

export function DeliveryAddressRequestToJSONTyped(
    value?: DeliveryAddressRequest | null,
