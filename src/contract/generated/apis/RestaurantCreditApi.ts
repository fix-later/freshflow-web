...
export class RestaurantCreditApi extends runtime.BaseAPI {
     ...
     */
    async apiV1RestaurantsRestaurantIdCreditGetRequestOpts(
        requestParameters: ApiV1RestaurantsRestaurantIdCreditGetRequest
    ...
    /**
     */
    async apiV1RestaurantsRestaurantIdCreditGetRaw(
        requestParameters: ApiV1RestaurantsRestaurantIdCreditGetRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<void>> {
        const requestOptions =
            await this.apiV1RestaurantsRestaurantIdCreditGetRequestOpts(
                requestParameters
            );
    ...
    /**
     */
    async apiV1RestaurantsRestaurantIdCreditGet(
        requestParameters: ApiV1RestaurantsRestaurantIdCreditGetRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<void> {
        await this.apiV1RestaurantsRestaurantIdCreditGetRaw(
            requestParameters,
            initOverrides
        );
    }
    ...
    async apiV1RestaurantsRestaurantIdCreditTransactionsGetRequestOpts(
        requestParameters: ApiV1RestaurantsRestaurantIdCreditTransactionsGetRequest
    ): Promise<runtime.RequestOpts> {
        if (requestParameters['restaurantId'] == null) {
            throw new runtime.RequiredError(
                'restaurantId',
    ...
    /**
     */
    async apiV1RestaurantsRestaurantIdCreditTransactionsGetRaw(
        requestParameters: ApiV1RestaurantsRestaurantIdCreditTransactionsGetRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<void>> {
        const requestOptions =
            await this.apiV1RestaurantsRestaurantIdCreditTransactionsGetRequestOpts(
                requestParameters
            );
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     */
    async apiV1RestaurantsRestaurantIdCreditTransactionsGet(
        requestParameters: ApiV1RestaurantsRestaurantIdCreditTransactionsGetRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<void> {
        await this.apiV1RestaurantsRestaurantIdCreditTransactionsGetRaw(
            requestParameters,
            initOverrides
        );
    }
