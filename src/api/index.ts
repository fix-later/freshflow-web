 ...
 *
 * Import everything from here (the `api` path maps to `src/api` via the
 * tsconfig `baseUrl`) rather than reaching into `./generated` directly:
 *
 *   import { productsApi, categoriesApi, PermissionError } from 'api';
 *
